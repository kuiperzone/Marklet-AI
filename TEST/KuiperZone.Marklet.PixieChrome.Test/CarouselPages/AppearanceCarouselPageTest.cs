...
public class AppearanceCarouselPageTest
{
    private readonly ITestOutputHelper _out;

    public AppearanceCarouselPageTest(ITestOutputHelper helper)
    {
        _out = helper;
    }
    ...
    {
        var obj = new AppearanceCarouselPage();
    ...
    private static AppearanceSettings NewSettings()
    {
        var obj = new AppearanceSettings();

        // Change from default state
        obj.Theme = ChromeTheme.Dark;
        obj.AccentColor = 0xFF232323;
        obj.Corners = CornerSize.Small;
        obj.PreferFluentDark = true;
