...
public class AppearanceCarouselTest
{
    private readonly ITestOutputHelper _out;

    public AppearanceCarouselTest(ITestOutputHelper helper)
    {
        _out = helper;
    }
    ...
    {
        var obj = new AppearanceCarousel();
    ...
    private static AppearanceSettings CreateSettings()
    {
