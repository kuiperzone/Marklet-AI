...
/// Search options.
/// </summary>
public sealed class SearchOptions : IEquatable<SearchOptions>
{
    /// <summary>
    /// Maximum length of <see cref="Keyword"/>.
    /// </summary>
    ...
    /// </summary>
    /// <remarks>
    /// A null or empty string will assign empty to <see cref="Keyword"/>. This will match no results.
    /// </remarks>
    public SearchOptions(string? keyword, SearchFlags flags = SearchFlags.None)
    {
    ...
    /// <summary>
    /// Gets the keyword or substring for which to search.
    /// </summary>
    /// <remarks>
    ...
    {
        return other != null && Keyword == other.Keyword &&
    ...
    {
        return Equals(obj as SearchOptions);
    }
    ...
    {
        return HashCode.Combine(Keyword, Flags, MaxSnippet, ScanLimit, MaxResults);
    }
}
