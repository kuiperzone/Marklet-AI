...
/// </summary>
internal sealed class PixieEditorCarousel : PixieCarousel
{
    public PixieEditorCarousel()
    {
        Title = nameof(PixieEditor);
        Symbol = Symbols.EditSquare;

        // EDITOR
        var group = CreateGroup(nameof(PixieEditor));

        var control = CreateControl<PixieEditor>(group, "");
        AddAccoutrements(control);
        control.LeftSymbol = Symbols.Archive;
        control.Subject.Text = nameof(PixieEditor);

        control = CreateControl<PixieEditor>(group);
        control.Title += " Left";
        control.Subject.Text = nameof(PixieEditor);
        ...
        control = CreateControl<PixieEditor>(group, "Long title Long title Long title Long title");
        control.Subject.Text = nameof(PixieEditor);
        ...
        control = CreateControl<PixieEditor>(group, false);
        control.Subject.Text = nameof(PixieEditor);
    }
}