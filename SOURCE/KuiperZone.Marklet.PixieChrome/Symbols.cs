...
/// <summary>
/// Selected "Material Symbol" codepoints.
/// </summary>
/// <remarks>
/// This contains symbols used or might use, and is expanded as we go. It does not restrict the use of material symbols.
/// Rather it allows for their use in code to be easily identified and maintained. Item naming, below, to strictly
/// follow material naming convention, so that "content_copy" => "ContentCopy".
/// </remarks>
public static class Symbols
{
    /// <summary>
    /// abc (letters monospace)
    /// </summary>
    ...
    /// </summary>
    public const string AccountSettingsBox = "\uf835";
    ...
    /// <summary>
    /// add_circle (See also <see cref="DoNotDisturbOn"/>
    /// </summary>
    ...
    /// <summary>
    /// auto_delete (trashcan with timer symbol)
    /// </summary>
    ...
    /// folder_code
    /// </summary>
    public const string CodeFolder = "\uf3c8";
    ...
    /// <summary>
    /// disabled_by_default (square cross)
    /// </summary>
    ...
    /// <summary>
    /// do_not_disturb_on (Bizarrely this serves as a counterpart to <see cref="AddCircle"/>).
    /// </summary>
    ...
    /// <summary>
    /// maximize (not same as traditional window maximize)
    /// </summary>
    ...
    /// <summary>
    /// network_intelligence (brain thing)
    /// </summary>
    ...
    /// <summary>
    /// select_window_2 (window restore)
    /// </summary>
    ...
    /// <summary>
    /// travel_explore (world with magnifying glass)
    /// </summary>
